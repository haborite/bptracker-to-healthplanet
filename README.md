...
[bptracker](https://play.google.com/store/apps/details?id=com.bloodpressureapp.bptracker) アプリのエクスポートデータ（SQLite3）を [Health Planet](https://www.healthplanet.jp/) の血圧入力画面へ自動転記するスクリプト。
